export const environment = {
  production: true,
  apiUrl: 'http://bsa2020-whale.westeurope.cloudapp.azure.com/api',
  meetingApiUrl: 'http://bsa2020-whale.westeurope.cloudapp.azure.com/meetingapi',
  signalrUrl: 'http://bsa2020-whale.westeurope.cloudapp.azure.com/hubs',
  firebase: {
