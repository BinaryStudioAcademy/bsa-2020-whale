...
namespace Whale.Shared.Services
{
    public class ContactsService : BaseService
    {
        ...
        public ContactsService(WhaleDbContext context, IMapper mapper, NotificationsService notifications, BlobStorageSettings blobStorageSettings, RedisService redisService) : base(context, mapper)
        {
